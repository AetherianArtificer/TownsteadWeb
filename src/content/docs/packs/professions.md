...
If the pack introduces a brand-new villager profession ID, read [Complete Runtime Support](/careers/profession/gated-careers/#complete-runtime-support) before installing it. Install it as a profile Data Pack through CurseForge or place it in the profile's `datapacks/` directory. Townstead scans recognised Career packs there before registry creation. Players and villagers share one progression path. A cooking station, a furnace, a block-interaction Job, or farm work credits a player who completes the same operation by hand; entity-delivery Jobs, fishing, and shearing credit villagers only.
